  ...
  _proto.renderField = function renderField(props) {
    ...
    var buttonBefore = function buttonBefore() {
      if ((0, _has2.default)(props.field, 'buttonBefore')) {
        return _react.default.createElement(_InputGroup.default.Append, null, props.field.buttonBefore());
      }
    };

    var buttonAfter = function buttonAfter() {
      if ((0, _has2.default)(props.field, 'buttonAfter')) {
        return _react.default.createElement(_InputGroup.default.Prepend, null, props.field.buttonAfter());
      }
    };
    ...
    var getLabel = function getLabel() {
      if (props.field.label) {
        return _react.default.createElement(_Col.default, (0, _extends2.default)({
          componentClass: _FormControl.default
        }, labelSize()), props.field.label);
      }
    };

    var rendered = _react.default.createElement(_FormGroup.default, (0, _extends2.default)({}, thisSize(), {
