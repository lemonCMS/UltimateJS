...
function (_React$Component) {
  (0, _inheritsLoose2.default)(Resourcebinder, _React$Component);

  function Resourcebinder() {
    var _this;

    _this = _React$Component.call(this) || this;
    _this.openResource = _this.openResource.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this.closeResource = _this.closeResource.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this.options = _this.options.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this.callBack = _this.callBack.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this.getList = _this.getList.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this.state = {
      showResource: false,
      list: []
    };
