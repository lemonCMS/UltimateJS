...
function (_React$Component) {
  ...
  _proto.dropDown = function dropDown(props) {
    ...
    (0, _map2.default)(props.field.children, function (item, key) {
      ...
      if (item.props.selected) {
        menuItem.push(_react.default.createElement(_Dropdown.Divider, null));
      }
    });
    return {
  ...
  _proto.renderField = function renderField(props) {
    ...
    var rendered = _react.default.createElement(_FormGroup.default, (0, _extends2.default)({
      as: _Row.default
    }, thisSize()), getLabel(), _react.default.createElement(_Col.default, fieldSize(), getField(), props.field.help && (!touched || !submitError && !error) && _react.default.createElement(_FormText.default, null, props.field.help), (touched && error || submitFailed && submitError) && _react.default.createElement(_FormControl.default.Feedback, {
      type: 'invalid'
    }, submitError || error)));
