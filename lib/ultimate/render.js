...
let _objectWithoutPropertiesLoose2 = _interopRequireDefault(
...
let ReactDOMServer = _interopRequireWildcard(require('react-dom/server'));

let _reactHelmet = _interopRequireDefault(require('react-helmet'));

let _reactRouterDom = require('react-router-dom');

let _redial = require('../redial');

let _Document = _interopRequireDefault(require('./Document'));
...
let modPageFn = function modPageFn(Page) {
          ...
          while (1) {
            switch ((_context3.prev = _context3.next)) {
                  ...
                  (function() {
                    let _ref = (0, _asyncToGenerator2.default)(
                      ...
                      _regenerator.default.mark(function _callee(fn) {
                        let defaultRenderer, renderer, renderedContent, helmet;
                        return _regenerator.default.wrap(
                          _context => {
                            while (1) {
              ...
              case 6:
                ...
                _context3.next = 13;
                return (0, _redial.authorizeWait)(
                  'authorized',
                  components,
                  locals,
                )
                  .then(
                    ...
                    (0, _asyncToGenerator2.default)(
                      ...
                      _regenerator.default.mark(function _callee2() {
                        let triggers, _ref4, html, docProps, doc;
                          ...
                          _context2 => {
                            while (1) {
                              switch ((_context2.prev = _context2.next)) {
                                case 0:
                                  triggers = (0, _redial.triggerWait)(
                                    'fetch',
                                    components,
                                    locals,
                                  );
                                ...
                                case 10:
                                  if (
                                    !(match && match.redirectTo && match.path)
                                  ) {
                                    _context2.next = 13;
                                    break;
                                  }
                                ...
                                case 15:
                                  ...
                                  doc = ReactDOMServer.renderToStaticMarkup(
                                    React.createElement(Doc, docProps),
                                  );
                                  return _context2.abrupt(
                                    'return',
                                    `<!doctype html>${doc.replace(
