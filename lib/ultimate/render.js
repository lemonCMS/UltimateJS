    ...
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            req = options.req, res = options.res, routes = options.routes, assets = options.assets, document = options.document, customRenderer = options.customRenderer, store = options.store, client = options.client, history = options.history, rest = (0, _objectWithoutPropertiesLoose2.default)(options, ["req", "res", "routes", "assets", "document", "customRenderer", "store", "client", "history"]);
