...
function createAllParamsForFetch(props, match, history) {
  var pathname = (0, _get2.default)(history, 'location.pathname', null);
  var params = (0, _assign2.default)((0, _get2.default)(props, ['routesState', 'routes', pathname, 'form'], {}), _qs.default.parse((0, _get2.default)(history, 'location.search', ''), {
      ...
      _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
        if (this.props.match.path === prevProps.match.path) {
          if (!(0, _isEqual2.default)(this.state, prevProps.history.location.state)) {
            if ((0, _isObject2.default)(prevProps.history.location.state)) {
              this.props.dispatch((0, _actions.storeState)(prevProps.history.location.pathname, prevProps.history.location.state));
              this.setState({
