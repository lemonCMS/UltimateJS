...
import FormControl from 'react-bootstrap/lib/FormControl'; // import FormText from 'react-bootstrap/lib/FormText';
// import FormCheck from 'react-bootstrap/lib/FormCheck';
// import FormControl from 'react-bootstrap/lib/FormControl';

import InputGroup from 'react-bootstrap/lib/InputGroup'; // import FormGroup from 'react-bootstrap/lib/FormGroup';
...
function (_React$Component) {
  ...
  _proto.dropDown = function dropDown(props) {
    ...
    _map(props.field.children, function (item, key) {
      ...
      if (item.props.selected) {
        menuItem.push(React.createElement(Divider, null));
      }
    });
  ...
  _proto.dropdownButton = function dropdownButton(props, isStatic) {
    ...
    var size = _get(props.field, 'size', this.props.size);
    ...
    if (isStatic === true || disabled === true) {
      return React.createElement(FormControl, {
        plaintext: true,
        readOnly: true,
        defaultValue: dropDownTitle || _get(props.field, 'placeholder')
      });
    }
  ...
  _proto.renderField = function renderField(props) {
    ...
    var buttonAfter = function buttonAfter() {
      if (_has(props.field, 'buttonAfter')) {
        return React.createElement(InputGroup.Append, null, props.field.buttonAfter());
      }
    };
