...
import asyncMatchRoutes from '../asyncMatchRoutes'; // require('./nprogress.css');
...
function (_Component) {
  ...
  function ReduxAsyncConnect() {
    ...
    _this.getAsyncData = _this.getAsyncData.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  /*#__PURE__*/
  function () {
    var _getAsyncData = _asyncToGenerator(
    /*#__PURE__*/
    _regeneratorRuntime.mark(function _callee3(history, location, routes, store, helpers) {
      var _this2 = this;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return asyncMatchRoutes(routes, this.props.location.pathname);
            ...
            case 4:
              ...
              return asyncMap(components, function (component) {
                return authorize('authorized', component, _extends({}, helpers, {
                  store: store,
                  match: match,
                  params: params,
                  history: history,
                    ...
                    switch (_context2.prev = _context2.next) {
                      case 0:
                            ...
                            return _regeneratorRuntime.wrap(function _callee$(_context) {
                              while (1) {
                                switch (_context.prev = _context.next) {
                                  case 0:
                                    _context.next = 2;
                                    return trigger('fetch', components, _extends({}, helpers, {
                                      store: store,
                                      match: match,
                                      params: params,
                                      history: history,
                        ...
                        if (process.env.BUILD_TARGET === 'client') {
                          trigger('defer', components, _extends({}, helpers, {
                            store: store,
                            match: match,
                            params: params,
                            history: history,
